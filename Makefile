...
.PHONY: test test-verbose test-coverage build run clean help docker-build docker-run docker-compose-up docker-compose-down
...
ci: fmt lint test ## Pipeline de CI (format, lint, test)
